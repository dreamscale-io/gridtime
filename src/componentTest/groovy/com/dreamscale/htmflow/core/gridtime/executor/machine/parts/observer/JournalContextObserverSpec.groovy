...
//        storyTile = new TileBuilder("@torchie/id", clock.getActiveCoords(), ZoomLevel.TWENTIES)
//    }
//
...
//        journalContextObserver.seeInto(window, storyTile)
//
//        TileBuilder nextFrame = new TileBuilder("@torchie/id", clock.getActiveCoords().panRight(ZoomLevel.TWENTIES).panRight(ZoomLevel.TWENTIES), ZoomLevel.TWENTIES);
