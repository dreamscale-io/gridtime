...
import com.dreamscale.ideaflow.core.domain.IntentionEntity
...
@ComponentTest
class IdeaFlowSourceSpec extends Specification {
    ...
    IdeaFlowSource journalFlowSource
    Window latestWindow
    IdeaFlowSource activityFlowSource
    ...
    def setup() {
        ...
        this.journalFlowSource = new IdeaFlowSource(memberId, featurePool, journalFetcher, flowObserverMock)
        this.activityFlowSource = new IdeaFlowSource(memberId, featurePool, fileActivityFetcher, flowObserverMock)
    }
