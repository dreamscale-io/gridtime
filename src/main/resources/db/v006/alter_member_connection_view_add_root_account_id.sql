...
create view member_connection_view as
  select om.organization_id, om.id member_id, r.id root_account_id, aas.connection_id, aas.last_heartbeat, aas.last_activity, om.username, r.display_name, r.full_name
