...
alter table organization_member
    rename column lower_case_user_name to lowercase_username;

alter table root_account
    rename column lower_case_root_user_name to lowercase_root_username;

alter table root_account
    rename column root_user_name to root_username;
