...
select tm.member_id id, tm.team_id, om.organization_id, om.email, m.full_name, m2.mood_rating, xp.total_xp, a.last_activity, a.active_status,
  w.active_task_id, t.name as active_task_name, t.summary as active_task_summary, w.working_on, w.spirit_status, w.spirit_message, w.active_circle_id, w.active_circle_start
from team_member tm
