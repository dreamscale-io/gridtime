...
import com.dreamscale.ideaflow.core.feeds.executor.machine.window.FlowWindow
import com.dreamscale.ideaflow.core.feeds.executor.machine.state.FlowOneWithResonance
