...
import com.dreamscale.htmflow.core.feeds.story.feature.sequence.IdeaFlowLayer;
import com.dreamscale.htmflow.core.feeds.story.feature.sequence.IdeaFlowLayerType;
...
public class IdeaFlowSequenceMapper {
    ...
    public IdeaFlowSequenceMapper(StoryGeometryClock.Coords storyCoordinates, ZoomLevel zoomLevel) {
