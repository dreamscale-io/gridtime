...
public class StoryGeometryClock {
    ...
    public StoryGeometryClock(LocalDateTime clockTime) {
    ...
    public static class Coords {
        ...
        public Coords minusMinutes() {
            return StoryGeometryClock.createGeometryCoords(clockTime.minusMinutes(ZoomLevel.MIN.buckets()));
        }

        public Coords minusHour() {
            return StoryGeometryClock.createGeometryCoords(clockTime.minusHours(1));
        }

        public Coords minusDay() {
            return StoryGeometryClock.createGeometryCoords(clockTime.minusDays(1));
        }

        public Coords minusWeek() {
            return StoryGeometryClock.createGeometryCoords(clockTime.minusWeeks(1));
        }

        public Coords minusBlock() {
            return StoryGeometryClock.createGeometryCoords(clockTime.minusWeeks(ZoomLevel.BLOCK.buckets()));
        }

        public Coords minusYear() {
            return StoryGeometryClock.createGeometryCoords(clockTime.minusYears(1));
        }

        // pan right functions

        public Coords plusMinutes() {
            return StoryGeometryClock.createGeometryCoords(clockTime.plusMinutes(ZoomLevel.MIN.buckets()));
        }

        public Coords plusHour() {
            return StoryGeometryClock.createGeometryCoords(clockTime.plusHours(1));
        }

        public Coords plusDay() {
            return StoryGeometryClock.createGeometryCoords(clockTime.plusDays(1));
        }

        public Coords plusWeek() {
            return StoryGeometryClock.createGeometryCoords(clockTime.plusWeeks(1));
        }

        public Coords plusBlock() {
            return StoryGeometryClock.createGeometryCoords(clockTime.plusWeeks(ZoomLevel.BLOCK.buckets()));
        }

        public Coords plusYear() {
            return StoryGeometryClock.createGeometryCoords(clockTime.plusYears(1));
        }
    }
