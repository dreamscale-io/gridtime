...
import com.dreamscale.htmflow.core.feeds.executor.machine.window.FlowWindow
import com.dreamscale.htmflow.core.feeds.executor.machine.state.FlowOneWithResonance
