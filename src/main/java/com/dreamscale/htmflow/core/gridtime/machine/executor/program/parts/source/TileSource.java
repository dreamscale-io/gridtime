...
public class TileSource<T extends Flowable> implements Flow {

    private final List<FlowObserver<T>> flowObservers;
    private final FeaturePool featurePool;
    private final Feed<T> sourceFeed;

    public TileSource(UUID memberId, FeaturePool featurePool, FetchStrategy<T> fetchStrategy, FlowObserver<T>... observers) {
