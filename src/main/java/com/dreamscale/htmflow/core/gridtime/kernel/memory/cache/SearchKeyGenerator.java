package com.dreamscale.htmflow.core.gridtime.kernel.memory.cache;


import com.dreamscale.htmflow.core.domain.member.json.Member;
import com.dreamscale.htmflow.core.gridtime.kernel.memory.type.*;
...
public class SearchKeyGenerator {
    ...
    public static String createLocationSearchKey(UUID projectId, String locationPath) {
        ...
        return PlaceType.LOCATION.expandUri(variableMap);
    }

    public static String createBoxSearchKey(UUID projectId, String boxName) {
        Map<String, String> variableMap = new HashMap<>();
        variableMap.put(PlaceType.TemplateVariable.PROJECT_ID, projectId.toString());
    ...
    public static String createBridgeSearchKey(UUID projectId, String fromBox, String fromLocationPath, String toBox, String toLocationPath) {
        ...
        return PlaceType.BRIDGE_BETWEEN_BOXES.expandUri(variableMap);
    }
    ...
    public static String createTraversalSearchKey(UUID projectId, String boxName, String fromLocationPath, String toLocationPath) {
        String fromLocation = standardizePath(fromLocationPath);
        String toLocation = standardizePath(toLocationPath);
        ...
        return PlaceType.TRAVERSAL_IN_BOX.expandUri(variableMap);
    }
